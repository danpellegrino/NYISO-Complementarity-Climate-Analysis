...
matplot(years, tmp.ts.year, type = "l", xlab = "Year", ylab = "Surface Downwelling Shortwave Radiation (W/m^2)", main = "Surface Downwelling Shortwave Radiation Sum in NYISO Zone C (1850-2100)")